...
public class UserServiceTest {
    ...
    public void createUserTest() {
        ...
        assertEquals(1, result.getFavoriteCatBreedsDto().size());
        assertEquals(1, result.getFavoriteDogBreedsDto().size());
    }
    ...
    public void getAllUsersTest() {
        ...
        assertEquals(1, result.get(0).getFavoriteCatBreedsDto().size());
        assertEquals(1, result.get(0).getFavoriteDogBreedsDto().size());
    }
