...
public class TrainingGuideDtoTest {
    ...
    void setUp() {
        ...
        catBreeds.add(new CatBreedDto(1L, "Siamese", "Thailand", 2, "Short", "Cream with points", "12-16 years", "Affectionate, Social, Vocal", "Popular breed known for its striking appearance and vocal nature."));

        List<DogBreedDto> dogBreeds = new ArrayList<>();
        dogBreeds.add(new DogBreedDto(1L, "Labrador", "Canada", 3, "Short", "Yellow", "10-12 years", "Friendly, Active", "Well-known for being friendly and good with children."));
    ...
    public void equalsAndHashCodeTest() {
        ...
        TrainingGuideDto trainingGuideDto1 = new TrainingGuideDto(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, dogBreeds);
        TrainingGuideDto trainingGuideDto2 = new TrainingGuideDto(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, dogBreeds);
    ...
    public void notEqualsAndHashCodeTest() {
        ...
        TrainingGuideDto trainingGuideDto1 = new TrainingGuideDto(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, new ArrayList<>());
        TrainingGuideDto trainingGuideDto2 = new TrainingGuideDto(2L, "Advanced Training Guide for Dogs", "This is an advanced training guide specifically for dogs.", new ArrayList<>(), null);
    ...
    public void toStringTest() {
        assertEquals("TrainingGuideDto(id=1, title=Basic Training Guide for Pets, content=This is a basic training guide for both cats and dogs., catsBreedDto=[CatBreedDto(id=1, name=Siamese, origin=Thailand, size=2, coat=Short, color=Cream with points, lifeSpan=12-16 years, temperament=Affectionate, Social, Vocal, description=Popular breed known for its striking appearance and vocal nature.)], dogsBreedDto=[DogBreedDto(id=1, name=Labrador, origin=Canada, size=3, coat=Short, color=Yellow, lifeSpan=10-12 years, temperament=Friendly, Active, description=Well-known for being friendly and good with children.)])", trainingGuideDto.toString());
    }
}
