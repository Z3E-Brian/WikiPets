...
public class TrainingGuideTest {
    ...
    public void equalsAndHashCodeTest() {
        ...
        TrainingGuide trainingGuide1 = new TrainingGuide(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, dogBreeds,1L);
        TrainingGuide trainingGuide2 = new TrainingGuide(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, dogBreeds,1L);
    ...
    public void notEqualsAndHashCodeTest() {
        ...
        TrainingGuide trainingGuide1 = new TrainingGuide(1L, "Basic Training Guide for Pets", "This is a basic training guide for both cats and dogs.", catBreeds, new ArrayList<>(),1L);
        TrainingGuide trainingGuide2 = new TrainingGuide(2L, "Advanced Training Guide for Dogs", "This is an advanced training guide specifically for dogs.", new ArrayList<>(), null,1L);
    ...
    public void toStringTest() {
        assertEquals("TrainingGuide(id=1, " +
                ...
                "Active, description=Well-known for being friendly and good with children.)], version=null)"
